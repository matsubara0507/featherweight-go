...
var $author$project$Main$Model = F2(
	function (input, error) {
		return {error: error, input: input};
	});
...
var $author$project$Go$Parser$Helper$displayDeadEnd = function (err) {
	return $elm$core$String$concat(
		_List_fromArray(
			[
				$elm$core$String$fromInt(err.row),
				':',
				$elm$core$String$fromInt(err.col),
				' ',
				$author$project$Go$Parser$Helper$displayProblem(err.problem)
			]));
};
...
var $author$project$Go$Parser$Helper$blockWith = F2(
	function (_v0, p) {
		...
		return $elm$parser$Parser$sequence(
			{end: end, item: p, separator: ',', spaces: $elm$parser$Parser$spaces, start: start, trailing: $elm$parser$Parser$Optional});
	});
...
var $author$project$Go$Featherweight$Syntax$nameParser = $elm$parser$Parser$variable(
	{
		...
		reserved: $author$project$Go$Featherweight$Syntax$keywords,
...
try {
	...
	throw 'Some top-level definitions from `Go.Featherweight.Syntax` are causing infinite recursion:\n\n  ┌─────┐\n  │    expParser\n  │     ↓\n  │    expParserWithExp\n  │     ↓\n  │    expParserWithExpAndName\n  │     ↓\n  │    expParserWithName\n  │     ↓\n  │    stepExpParserWithExp\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Main$parseFG = function (model) {
	var _v0 = A2($elm$parser$Parser$run, $author$project$Go$Featherweight$Syntax$parser, model.input);
	if (_v0.$ === 'Ok') {
		...
		return _Utils_update(
			model,
			{
				error: $author$project$Go$Parser$Helper$displayError(err)
			});
	}
};
